...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.Smartlook.Smartlook.flutter_smartlook.SmartlookPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_smartlook, com.Smartlook.Smartlook.flutter_smartlook.SmartlookPlugin", e);
    }
    try {
